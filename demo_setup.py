...
def setup_demo_environment():
    ...
    print("\n---------------------------------------------------------------")
    print("DEMONSTRATION COMMANDS (Open 3 Separate Terminal Windows):")
    print("---------------------------------------------------------------")
    print("Terminal 1 (Peer A - Seeder):")
    print(f"  python main.py --peer-id PEER_A --port 5001 --shared-dir shared_files/peer_a --downloads-dir downloads/peer_a --loss 0.10\n")
    print("Terminal 2 (Peer C - Seeder):")
    print(f"  python main.py --peer-id PEER_C --port 5003 --shared-dir shared_files/peer_c --downloads-dir downloads/peer_c --loss 0.10\n")
    print("Terminal 3 (Peer B - Downloader):")
    print(f"  python main.py --peer-id PEER_B --port 5002 --shared-dir shared_files/peer_b --downloads-dir downloads/peer_b --loss 0.20\n")
    print("In Peer B's terminal, select option [2] to download 'movie.mp4'.")
    print("You will witness concurrent chunks downloading from Peer A and Peer C,")
    print("selective retransmissions on dropped packets, and SHA-256 verification!")
    print("===============================================================\n")
